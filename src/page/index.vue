        ...
        <el-tabs tab-position="left">
          <el-tab-pane class="technology-tab-container" label="新能源">
            <el-row
              :gutter="10"
              class="technology-item"
              v-for="demand in demands.newEnergy"
              :key="demand.index"
            >
              <el-col :span="8">
          ...
          <el-tab-pane class="technology-tab-container" label="高新技术材料">
            <el-row
              :gutter="10"
              class="technology-item"
              v-for="demand in demands.material"
              :key="demand.index"
            >
              <el-col :span="8">
                <div class="technology-title">{{demand.title}}</div>
          ...
          <el-tab-pane class="technology-tab-container" label="信息技术">
            <el-row
              :gutter="10"
              class="technology-item"
              v-for="demand in demands.infoTech"
              :key="demand.index"
            >
              <el-col :span="8">
                <div class="technology-title">{{demand.title}}</div>
...
.technology-container {
  ...
  .technology-find-more-container {
    border-top: 1px solid #ccc;
    padding-top: 20px;
    text-align: center;
    .technology-find-more {
      display: inline-block;
      background: #000;
      border-radius: 5px;
      padding: 5px 10px;
