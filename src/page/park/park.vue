    ...
    <div class="government-service-container">
      ...
      <el-row :gutter="60">
        <el-col :span="6">
          <div>
            <el-image
              src="static/img/icon/analyse.png"
              style="width: 50px;height:50px;vertical-align:middle"
            ></el-image>
            <h2>区域技术市场</h2>
    ...
    <div class="conponents">
      ...
      <el-tabs class="conponents-tab" tab-position="left">
        ...
        <el-tab-pane label="xx科技创业小镇">
          <p>杭州梦想小镇位于杭州余杭区，规划面积3平方公里，是浙江省首批特色小镇创建对象，也是10个省级示范特色小镇之一。小镇定位信息产业，主攻互联网创新创业，努力成为众创空间的新榜样、信息经济的新增点。梦想小镇依托浙大、阿里、浙商优势，顺应“互联网+”的发展浪潮，抓住“大众创业、万众创新”的时代机遇，锁定人才和资本两大关键创新要素，确定了“资智融合”的发展路径，加快互联网创业和天使投资互促发展。</p>
          <div class="conponents-image">
